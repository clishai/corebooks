...
The accounting engine, database, REST API, browser-based UI, and Electron desktop app are all functional. It includes:
...
**Next up:** Accounts receivable / payable manager, inventory module, other potential/requested modules, and a signed public installer for one-click download.
...
That is it. No separate database software needed as corebooks uses SQLite, a lightweight database stored in a single file on your computer.
