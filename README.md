...
The accounting engine, database, REST API, browser-based UI, and Electron desktop app are all functional. The app is dark-themed, fully navigable, and includes:
